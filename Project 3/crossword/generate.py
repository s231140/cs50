...
class CrosswordCreator():
    ...
    def consistent(self, assignment):
        ...
        # Check each variable's word length
        for var, word in assignment.items():
            if len(word) != var.length:
                return False

        # Check all overlaps between assigned variables
        for x in assignment:
            for y in assignment:
                if x == y:
                    continue
    ...
    def backtrack(self, assignment):
        ...
        for value in self.order_domain_values(var, assignment):
            ...
            if self.consistent(new_assignment):
                ...
                # Make a copy of current assignment for inference
                inference_assignment = new_assignment.copy()
                
                # Try to maintain arc consistency
                result = self.backtrack(new_assignment)
                if result is not None:
                    return result
                
                # Restore domains if inference failed
